...
def hero():
    ...
    while(y):
        ...
        if (len(numbers)>11):
            ...
            print("Play on Current specified time!!")
...
if(expirydate>today):
    ...
    First = now.replace(hour=Current, minute=Current, second=0, microsecond=0)
    Firstend = now.replace(hour=Current, minute=Current, second=0, microsecond=0)
